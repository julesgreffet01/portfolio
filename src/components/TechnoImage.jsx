export default function TechnoImage({ src, alt, ShadowColor, FondColor, size = 100, text = "" }) {
    return (
        <div className={`w-45 h-45 bg-border rounded-lg m-auto flex items-center justify-center transition-shadow duration-300 ease-[cubic-bezier(0,0,0.2,1)] hover:shadow-xl ${ShadowColor} relative overflow-hidden`}>
